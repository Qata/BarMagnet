...
- (NSMutableURLRequest *)universalPOSTSetting {
    ...
    [dir length] ? [requestAppend addObject:[NSString stringWithFormat:@"dir_edit=%@", [dir stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLHostAllowedCharacterSet]]]]
                 : nil;
...
- (NSURLRequest *)virtualHandleMagnetLink:(NSString *)magnetLink {
    ...
    [request setHTTPBody:[[@"url=" stringByAppendingString:[[magnetLink stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLHostAllowedCharacterSet]] encodeAmpersands]]
