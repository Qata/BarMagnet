    ...
    for (NSString *dictKey in torrentJobs) {
      if ([torrentJobs[dictKey] respondsToSelector:@selector(objectForKey:)]) {
        ...
        [self insertTorrentJobsDictWithArray:@[
          torrentDict[@"hash"], torrentDict[@"name"], torrentDict[@"progress"], torrentDict[@"state"],
          [torrentDict[@"download_payload_rate"] transferRateString], [torrentDict[@"upload_payload_rate"] transferRateString], [torrentDict[@"eta"] ETAString],
          [torrentDict[@"total_done"] sizeString], [torrentDict[@"total_uploaded"] sizeString], torrentDict[@"total_size"], torrentDict[@"num_peers"],
          torrentDict[@"num_seeds"], torrentDict[@"download_payload_rate"], torrentDict[@"upload_payload_rate"],
          @([torrentDict[@"total_done"] doubleValue] ? [torrentDict[@"total_uploaded"] doubleValue] / [torrentDict[@"total_done"] doubleValue] : 0)
        ]
                                    intoDict:tempJobs];
      }
    }
...
- (NSMutableURLRequest *)universalPOSTSetting {
  ...
  [request setHTTPBody:[NSJSONSerialization dataWithJSONObject:@{
             @"id" : randomID,
             @"method" : @"auth.login",
             @"params" : @[ [[self getWebDataForKey:@"password"] orSome:@""] ]
           }
                                                       options:0
                                                         error:nil]];
  if (error) {
...
- (NSURLRequest *)virtualHandleMagnetLink:(NSString *)magnetLink {
  ...
  [request setHTTPBody:[NSJSONSerialization dataWithJSONObject:@{
             @"id" : @([randomID intValue] + 1),
             @"method" : @"core.add_torrent_magnet",
             @"params" : @[ magnetLink, options ]
           }
                                                       options:0
                                                         error:nil]];
  return request;
...
- (NSURLRequest *)virtualHandleTorrentFile:(NSData *)fileData withURL:(NSURL *)fileURL {
  ...
  [request setHTTPBody:[NSJSONSerialization dataWithJSONObject:@{
             ...
             @"params" : @[ [fileURL absoluteString], [fileData base64EncodedStringWithOptions:0], options ]
           }
                                                       options:0
                                                         error:nil]];
  return request;
