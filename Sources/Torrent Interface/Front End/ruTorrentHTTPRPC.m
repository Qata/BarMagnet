  ...
  for (NSString *key in dict) {
    ...
    if (td.count >= 34) {
      ...
      [self insertTorrentJobsDictWithArray:@[
        key, td[4], percentDone, status, [td[12] transferRateString], [td[11] transferRateString], ETA, [td[8] sizeString], [td[9] sizeString],
        [td[5] toNumber], td[15], td[18], td[12], td[11], @([td[8] doubleValue] ? [td[9] doubleValue] / [td[8] doubleValue] : 0), td[21]
      ]
                                  intoDict:tempJobs];
    }
  }
