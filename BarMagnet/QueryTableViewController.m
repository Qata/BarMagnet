	...
	else if (!indexPath.section)
	{
		switch (indexPath.row)
		{
			...
			case 1:
			{
				...
				{
					[[UIAlertView.alloc initWithTitle:@"Unsupported Feature" message:@"This feature is only supported on devices running 7.0 or greater" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil] show];
				}
				break;
			}
		}
